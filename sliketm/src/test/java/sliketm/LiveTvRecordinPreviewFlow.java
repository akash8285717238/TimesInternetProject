...
public class LiveTvRecordinPreviewFlow {
    @Test()
        ...
        for (String channel : c1) 
        {
            ...
            for (String windowHandle : allWindowHandles) {
                if (!windowHandle.equals(parentWindowHandle)) {
                   ...
                   // WebElement element = driver.findElement(By.xpath("(//div[@class='__ply'])[2]")); //locater

                    // Assertion - Check if the element is visible
                   // Assert.assertTrue(element.isDisplayed(), "Element is visible.");
